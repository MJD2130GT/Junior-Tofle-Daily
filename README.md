...
- `~0500`: 기본 문항 (Lv1~2 중심)
- `0501~`: **상위 난이도(Lv3~5)** — 독해는 추론·주제·어휘·지시어, 문법은 가정법·분사·사역·도치·관계사 등
- 전부 `tools/generate_questions.js`로 생성 (시드 고정 → 재실행해도 동일, 기존 ID 보존).
  1000개를 맞추기 위해 자동생성 Lv1/Lv2 일부를 제거하며, 이때 ID 번호에 빈 자리가 생길 수 있으나 남는 문항의 ID·내용은 그대로 유지됩니다.

난이도 분포: Lv1 269 · Lv2 514 · Lv3 125 · Lv4 65 · Lv5 27 (1~5 척도).
